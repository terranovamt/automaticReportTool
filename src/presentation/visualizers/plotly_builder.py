"""
ART.stdf - Plotly Visualization Builder

This module provides comprehensive Plotly visualization functions for
semiconductor test data analysis.

Key Features:
- Interactive histograms with temperature/corner sliders
- Combined histogram + heatmap dashboards
- Box plots with multiple splits
- Scatter plots for yield analysis
- Limit visualization with normal distributions
...
def scatter(
    ...
    fig = make_subplots(
        rows=n_corners,
        vertical_spacing=0.25 / n_corners,
        cols=1,
