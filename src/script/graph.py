...
<div>
    ...
    <div class="controls-container">
        <div class="control-group">
            ...
            <select id="split-dropdown" class="control-select split-select">
                {' '.join([f'<option value="{split}" {"selected" if split == default_split else ""}>{split}</option>' for split in all_split])}
            </select>
        </div>
